...
For the past 3 months, we have struggled to submit to Kaggle. We first tried
to submit over 3 months ago and have tried at uniform time intervals since then.
...
already solidified our entire pipeline and our predictions thus have not changed.
Thus, we do not believe that our Kaggle submission history conveys very much
information, as it is comprised merely of a series of errors, followed by our
final score.
