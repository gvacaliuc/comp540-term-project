...
On top of the outline previously described, we also trained a Mask RCNN based off
of the \newline\href{Matterport Implementation}{https://github.com/matterport/Mask\_RCNN}.
After modifying the code to train on the provided training set and to give predictions
for the stage 1 test set, we recieved an AP score of .477 \footnote{This
score of .477 is based off of our local implementation of AP using the Stage 1
data for scoring.}. However, we felt as if the purpose of the project is to
